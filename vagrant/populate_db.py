...
menuItem2 = MenuItem(
    name="Peking Duck", description=" A famous duck dish from Beijing[1] that \
    has been prepared since the imperial era. The meat is prized for its \
    thin \
    crisp skin, with authentic versions of the dish serving mostly the skin \
    and little meat, sliced in front of the diners by the cook",
